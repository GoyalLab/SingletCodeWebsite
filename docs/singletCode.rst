...
.. image:: /images/singletCode-1.png
   :scale: 50 %
   :alt: Schematic to show how doublets are identified by singletCode
   :caption: Schematic to show how doublets are identified by singletCode
...
.. image:: /images/singletCode-2.png
   :scale: 50 %
   :alt: Method to simulate doublets using true singlets from singletCode
   :caption: Method to simulate doublets using true singlets from singletCode
